...
class wpAnimateViewController: UIViewController {
        ...
        @objc func changeView() {
            ...
            let wpPrintViewController = self.storyboard?.instantiateViewController(withIdentifier: "towpLastPage") as! wpPrintViewController
            self.navigationController?.present(wpPrintViewController, animated: true)
